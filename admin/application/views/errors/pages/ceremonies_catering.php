		...
		<div class="media">
			<div class="media-body">
				<ul class="breadcrumb">
					...
					<li>Manage Ceremonies Catering</li>
				</ul>
				...
				<div class="panel panel-default">					
					<div class="panel-body text-center">
						 <h2> <?=$puja_data->description_charge;?></h2>
						  ...
						  <a href="<?=base_url();?>pages/Ceremonies_Catering/<?=$this->uri->segment(3);?>"><span class="btn btn-danger btn-lg"> Catering Menu</span></a>
				...
				<div class="panel panel-default">					
					<div class="panel-body">
						...
						<?php if($this->uri->segment(4)=='edit'){ ?>
							<form action="<?php echo base_url();?>Pages/Ceremonies_Catering/<?=$this->uri->segment(3)?>/edit/<?php echo $this->uri->segment(5); ?>/update" class="" role="form" id="form" method="post" accept-charset="utf-8">
						<?php } else { ?>	
							<form action="<?php echo base_url();?>Pages/Ceremonies_Catering/<?=$this->uri->segment(3)?>/insert" class="" role="form" id="form" method="post" accept-charset="utf-8">	
						<?php } ?>
...
<td>                                                                            
	<a href="<?php echo base_url();?>Pages/Ceremonies_Catering/<?=$this->uri->segment(3)?>/edit/<?php echo $myresult->id; ?>" title="Edit" class="btn-link btn_size has-tooltip text-info" data-placement="top" data-original-title="Edit" onclick="if (confirm('Are you sure?')){return true;}else{event.stopPropagation(); event.preventDefault();};"><i class="fa fa-edit"></i></a>
	
	<a href="<?php echo base_url();?>Pages/Ceremonies_Catering/<?=$this->uri->segment(3)?>/delete/<?php echo $myresult->id; ?>" title="inactive" class="btn-link btn_size has-tooltip text-info" data-placement="top" data-original-title="Edit" onclick="if (confirm('Are you sure?')){return true;}else{event.stopPropagation(); event.preventDefault();};"><i class="fa fa-trash"></i></a>
</td>       
