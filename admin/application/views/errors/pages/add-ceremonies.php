<div class="mainpanel">
	<div class="pageheader">
		<div class="media">
			<div class="media-body">
				...
				<h4>Create Ceremonies Booking</h4>
			</div>
		</div><!-- media -->
	</div><!-- pageheader -->
 ...
 <form action="<?php echo base_url();?>Pages/Add_Ceremonies/insert" class="" role="form" method="post" accept-charset="utf-8">	
					...
					<div class="form-group col-sm-12">
						<div class="col-sm-4">
							<label class="control-label required" for="description_charge">Description Of Charge <abbr class="text-danger">*</abbr></label>
						</div>
						<div class="col-sm-8">
							<input type="text" class="form-control" name="description_charge" id="description_charge" value="<?php if($this->uri->segment(3)=='edit'){ echo $all_packages->description_charge;  } else {  echo set_value('description_charge'); }?>" autocomplete="off" placeholder="Description Of Charge"/>
...
<input type="hidden"  name="puja_type" id="puja_type" value="Puja"/>
					...
					<div class="form-group col-sm-12">
						<div class="col-sm-4">
							<label class="control-label required" for="venue_price">Temple  Price <abbr class="text-danger">*</abbr></label>
						</div>
						<div class="col-sm-8">
