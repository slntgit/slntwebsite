...
<input  value="<?php if($this->uri->segment(3)=='edit'){ echo $all_packages->name;  } else {  echo set_value('name'); }?>" type="text" name="name" id="name" tabindex="1" class="form-control alphabet" placeholder="First name">
    ...
    <div class="col-md-4 col-sm-6">
        <div class="form-group">
            ...
            <input type="text" name="last_name" id="last_name" tabindex="1" class="form-control alphabet" placeholder="Last name" value="<?php if($this->uri->segment(3)=='edit'){ echo $all_packages->last_name;  } else {  echo set_value('last_name'); }?>">
