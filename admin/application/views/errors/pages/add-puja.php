		...
		<div class="media">
			<div class="media-body">
				<ul class="breadcrumb">
					...
					<li>Add Pooja Type</li>
				</ul>
				<h4>Add Pooja Type</h4>
			</div>
		</div><!-- media -->
	</div><!-- pageheader -->
				...
				<div class="panel panel-default">					
					<div class="panel-body text-center">
						 <h2> <?=$puja_data->description_charge;?></h2>
						  ...
						  <a href="<?=base_url();?>pages/BhogPrasad/<?=$this->uri->segment(4);?>"><span class="btn btn-info btn-lg"> Bhog / Prasad</span></a>
						  
						  
						  <a href="<?=base_url();?>pages/Catering/<?=$this->uri->segment(4);?>"><span class="btn btn-primary btn-lg"> Catering Menu</span></a>
...
<form action="<?php echo base_url();?>Pages/Add_Pooja/insert" class="" role="form" id="form" method="post" accept-charset="utf-8" enctype="multipart/form-data">	
					...
					<div class="form-group col-sm-12">
						<div class="col-sm-4">
							<label class="control-label required" for="description_charge">Pooja Type Name <abbr class="text-danger">*</abbr></label>
						</div>
						<div class="col-sm-8">
...
<input <?php if($this->uri->segment(3)=='edit'){ if($all_packages->puja_type=='Refreshment'){ ?>  checked="checked" <?php }}?>  type="radio" name="puja_type" id="puja_type" value="Refreshment" autocomplete="off"/> Refreshment &nbsp; &nbsp;
 ...
 <input <?php if($this->uri->segment(3)=='edit'){ if($all_packages->puja_type=='Tempal Charges'){ ?>  checked="checked" <?php }}?>  type="radio" name="puja_type" id="puja_type" value="Tempal Charges" autocomplete="off"/> Temple Charges &nbsp; &nbsp;
					...
					<div class="form-group col-sm-12">
						<div class="col-sm-4">
							<label class="control-label required" for="venue_price">Temple  Price </label>
						</div>
						<div class="col-sm-8">
							<input type="number" class="form-control" name="venue_price" id="venue_price" value="<?php if($this->uri->segment(3)=='edit'){ echo $all_packages->venue_price;  } else {  echo set_value('venue_price'); }?>" autocomplete="off" placeholder="Temple Price SGD"/>
					...
					<div class="form-group col-sm-12">
						...
						<div class="col-sm-8">
							<input type="number" class="form-control" name="member_price" id="member_price" value="<?php if($this->uri->segment(3)=='edit'){ echo $all_packages->member_price;  } else {  echo set_value('member_price'); }?>" autocomplete="off" placeholder="Member Price SGD"/>
					...
					<div class="form-group col-sm-12">
						...
						<div class="col-sm-8">
							<input type="number" class="form-control" name="non_member_price" id="non_member_price" value="<?php if($this->uri->segment(3)=='edit'){ echo $all_packages->non_member_price;  } else {  echo set_value('non_member_price'); }?>" autocomplete="off" placeholder="Non-Member Price SGD"/>
						...
						<div class="col-sm-12">
						    ...
						    <div class="row">
						        <div class="col-md-6">
						            ...
						            <input value="<?php if($this->uri->segment(3)=='edit'){ echo $all_packages->offer_mem_price;  } else {  echo set_value('offer_mem_price'); }?>" type="number"   name="offer_mem_price" id="offer_mem_price" class="form-control" placeholder="Member Price SGD" />
						        </div>
						         <div class="col-md-6">
						             <label>Non-Member Price SGD  </label>
						            <input value="<?php if($this->uri->segment(3)=='edit'){ echo $all_packages->offer_non_mem_price;  } else {  echo set_value('offer_non_mem_price'); }?>" type="number"  name="offer_non_mem_price" id="offer_non_mem_price" class="form-control" placeholder="Non-Member Price SGD" />
						        </div>
					...
					<div class="form-group col-sm-12">
						<div class="col-sm-4">
							<label class="control-label required" for="puja_image">Pooja Image <abbr class="text-danger">*</abbr></label>
						</div>
						<div class="col-sm-8">
...
<div class="form-group col-sm-12">
	<div class="col-sm-12">
		...
		<textarea class="form-control ckeditor" id="editor1" name="description"><?php if($this->uri->segment(3)=='edit'){ echo $all_packages->description; } ?></textarea>			    
    </div>
</div>						    
