						 ...
						 <table class="table table-bordered table-striped" id="example">
									...
									?>	
										...
										<tr>
											...
											<td> 
			<a href="<?php echo base_url();?>Pages/Samagri/<?php echo $myresult->id; ?>" title="Manage Details" class="btn  btn-xs btn_size has-tooltip text-success" data-placement="top" data-original-title="Edit">Manage</a>
