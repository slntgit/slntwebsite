...
<form action="<?php echo base_url();?>pages/Career/update/<?php echo $this->uri->segment(4); ?>" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">

	<input type="hidden" name="lastimage" value="<?php echo $website_edit_image->image;?>">
<?php  } else { ?>
<form action="<?php echo base_url();?>pages/Career/add" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
...
?>
                ...
                <tr role="row" class="odd">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="<?php echo base_url();?>pages/Career/edit/<?php echo $cimage->id; ?>" class="btn btn-info btn-xs">Edit</a>
                            <a href="<?php echo base_url();?>pages/Career/delete/<?php echo $cimage->id; ?>" class="btn btn-danger btn-xs">Delete</a>
