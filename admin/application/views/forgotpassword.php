            ...
            <div class="panel panel-signin">
                <div class="panel-body">
                    <div class="logo text-center">
                        <img src="<?php echo base_url();?>assets/images/logo-primary.png" alt="Please Wait.." >
                    </div>
                    <br />
                    <h4 class="text-center mb5">Forgot Password?</h4>
                    <p class="text-center">Chane your Password Settings</p>
                    ...
                    <form action="index.php" method="post">
                        <div class="input-group mb15">
                            ...
                            <input type="text" class="form-control" placeholder="Regsitered Mobile No">
                        </div><!-- input-group -->                       
                    ...
                    <p><a href="<?php echo base_url(); ?>"><i class="glyphicon glyphicon-user"></i> Sign In</a></p>
                </div><!-- panel-body -->                
            </div><!-- panel -->
