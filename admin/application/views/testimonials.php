...
<input type="hidden" name="image_category" class="form-control" value="1" id="image_category">
								...
								<div class="form-group">
									<label for="title" class="col-sm-3 control-label"><small>Name / Title</small></label>
									<div class="col-sm-9">
...
?></div>
								...
								<div class="form-group">
									<label for="editor1" class="col-sm-3 control-label"><small>Content </small></label>
									<div class="col-sm-9">

										<textarea name="content" class="form-control" id="editor1"><?php if ($this->uri->segment(3)=='edit') { echo $website_edit_image->content; } ?></textarea>
