			...
			<div class="col-sm-12 col-md-12 ">				
				<div class="panel panel-default">					
					<div class="panel-body text-center">
                        ...
                        <?php if($puja_data->pooja_samgri==1 || $puja_data->havan_samagri==1){ ?>
						    <a href="<?=base_url();?>pages/Samagri/<?=$this->uri->segment(3);?>"><span class="btn btn-primary btn-lg"> Samagri</span></a>
						 <?php } ?>
						 
						 <?php if($puja_data->blog_prasads==1){ ?><a href="<?=base_url();?>pages/BhogPrasad/<?=$this->uri->segment(3);?>"><span class="btn btn-info btn-lg"> Bhog / Prasad</span></a><?php } ?>
					...
					<div class="col-sm-3 col-xs-12">
					 ...
					 <table class="table table-bordered table-striped" id="example">
									<thead>
										<tr>
											<th>#</th>
										 	<th  class="width_action">Pooja Day </th><th  class="width_action">From  Time</th>
									...
									?>	
										...
										<tr>
											...
											<td><?php echo date('D',strtotime($myresult->pooja_date)); ?></td>	<td><?php echo $myresult->from_time; ?></td>
