                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="">
                            ...
                            <form action="<?=base_url('pages/ManageCatering/AddNewCatering');?>?action=doSave" method="post">
                                <div class="form-group col-sm-12">
                                    <div class="col-sm-2">
                                        <label class="control-label required" for="menu_name">Menu Name <abbr class="text-danger">*</abbr></label>
                                    </div>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="menu_name" id="menu_name" value="<?php echo set_value('menu_name'); ?>" autocomplete="off" placeholder="Menu Name *" required/>
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea  name="menu_items" class="ckeditor" id="editor1" ></textarea>
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <div class="col-sm-10">
                                         <label class="col-sm-3 col-xs-12"><input type="checkbox" name="days[]" id="Sun" value="Sun"> Sunday</label>
                                         <label class="col-sm-3 col-xs-12"><input type="checkbox" name="days[]" id="Mon" value="Mon"> Monday</label>
                                         <label class="col-sm-3 col-xs-12"><input type="checkbox" name="days[]" id="Tue" value="Tue"> Tuesday</label>
                                         <label class="col-sm-3 col-xs-12"><input type="checkbox" name="days[]" id="Wed" value="Wed"> Wednesday</label>
                                         <label class="col-sm-3 col-xs-12"><input type="checkbox" name="days[]" id="Thu" value="Thu"> Thursday</label>
                                         <label class="col-sm-3 col-xs-12"><input type="checkbox" name="days[]" id="Fri" value="Fri"> Friday </label>
                                         <label class="col-sm-3 col-xs-12"><input type="checkbox" name="days[]" id="Sat" value="Sat"> Saturday</label>
                                    </div>
                                </div>
                                 <div class="form-group col-sm-12">
                                    <div class="col-sm-2">
                                            ...
                                            <tbody id="price">
                                               <tr id="">
                                                <td>
                                                    ...
                                                    <input required type="number" class="form-control" name="no_of_pax[]" id="" value="">
                                                </td>
                                                <td>
                                                    <label>Member Price *</label>
                                                    <input required type="number" class="form-control" name="mem_price[]" id="" value="">
                                                </td>
                                                <td>
                                                    <label>Non-Member Price *</label>
                                                    <input required type="number" class="form-control" name="none_mem_price[]" id="" value="">
                                                </td>
                                                <td>
                                                    <br />
