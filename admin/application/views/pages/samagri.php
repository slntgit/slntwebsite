			...
			<div class="col-sm-12 col-md-12 ">				
				<div class="panel panel-default">					
					<div class="panel-body text-center">
						 ...
						 <?php if($puja_data->pooja_samgri==1 or $puja_data->havan_samagri==1){ ?>						  <a href="<?=base_url();?>pages/Samagri/<?php if($this->uri->segment(3)=='edit'){ $this->uri->segment(4);} else { echo $this->uri->segment(3);} ?>"><span class="btn btn-danger btn-lg"> Samagri</span></a>
<?php } ?>
...
<select name="samagri_type" id="samagri_type" class="form-control">
	<?php if($puja_data->pooja_samgri==1){ ?><option <?php if($this->uri->segment(4)=='edit'){ if($all_packages->samagri_type=='Puja Samagri'){ echo 'selected'; } }?> value="Puja Samagri">Pooja Samagri</option><?php } ?>
	<?php if($puja_data->havan_samagri==1){ ?><option <?php if($this->uri->segment(4)=='edit'){ if($all_packages->samagri_type=='Havan Samagri'){ echo 'selected'; } }?> value="Havan Samagri">Havan Samagri</option><?php } ?>
</select>
