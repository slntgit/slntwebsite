				...
				<div class="panel panel-default">					
					<div class="panel-body">
						<div class="">
                            ...
                            <tbody>
<?php if($lastmember->transection_slip!=''){ ?>
<tr>
    <td colspan="4" style="padding: 8px 4px; border:1px solid;  text-align: left !important;">
       <h4><a href="<?=base_url();?>../assets/membership/<?=$lastmember->transection_slip;?>" target="_blank">View Transection File</a></h4>  
    </td>
...
<tr>
    <td colspan="4" align="right">
          <form action="<?=base_url();?>pages/MembershipPayment/<?=$this->uri->segment(3);?>/collect" method="post"  enctype="multipart/form-data">
              <table class="table table-bordered ">
              		...
              		<tr>
              			<td>Transaction File (jpg,png,jpeg,pdf)</td>
              			<td>
