<div class="mainpanel">
		...
		<div class="media">
			<div class="media-body">
				<ul class="breadcrumb">
					...
					<li>Print Membership Details </li>
				</ul>
				<h4>Print Membership details of <?=$lastmember->name_title;?> <?=$lastmember->name_as_nric;?></h4>
			</div>
		</div><!-- media -->
	</div><!-- pageheader -->
	...
	<div class="row">
	<div class="col-sm-12">
 <a href="<?=base_url();?>pages/UserMembershpList/<?=$this->uri->segment(4);?>" class="btn btn-warnig"> <i class="fa fa-arrow-left" aria-hidden="true"></i> GO Back</a>
 <button onclick="PrintDiv();" class="btn btn-warnig"><i class="fa fa-print" aria-hidden="true"></i> Print</button>
...
<tr>
    <td style="padding: 8px 4px; border:1px solid;  text-align: left !important;">
     ...
     <td style="padding: 8px 4px; border:1px solid;  text-align: left !important;">
        <p><?=$lastmember->membership_id;?></p> 
    </td>
  
    
     <td style="padding: 8px 4px; border:1px solid;  text-align: left !important;" colspan="2">
        <p><strong>Membership Buy Date : </strong><?=date('d-M-Y',strtotime($lastmember->membership_buy));?></p> 
        <p><strong>Membership Expiry Date : </strong><?=date('d-M-Y',strtotime($lastmember->membership_expire));?></p> 
    </td>
...
<tr>
    <td style="padding: 8px 4px; border:1px solid;  text-align: left !important;">
     ...
     <td style="padding: 8px 4px; border:1px solid;  text-align: left !important;">
        <p><?=$lastmember->days;?>-<?=date('M',strtotime($lastmember->month));?>-<?=$lastmember->year;?></p> 
    </td>
