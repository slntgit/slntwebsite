                ...
                <div _ngcontent-ngq-c160="" class="row align-item-center justify-content-between">
                    <div class="col-md-12">
                        <section _ngcontent-ngq-c160="" class="header-title">
                            <p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">AGREEMENT TO TERMS: -</p>
                            ...
                            <p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">INTELLECTUAL PROPERTY RIGHTS</p>
                            ...
                            <p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">USER REPRESENTATIONS</p>
                            ...
                            <p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">USER REGISTRATION</p>
                            <p>You may be required to register with the Site. You agree to keep your password confidential and will be responsible for all use of your account and password. We reserve the right to remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.</p>
                           	
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">PROHIBITED ACTIVITIES</p>
							...
							<p>3. use a buying agent or purchasing agent to make purchases on the Site.</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">USER GENERATED CONTRIBUTIONS</p>
							<p>The Site may invite you to chat, contribute to, or participate in blogs, message boards, online forums, and other functionality, and may provide you with the opportunity to create, submit, post, display, transmit, perform, publish, distribute, or broadcast content and materials to us or on the Site, including but not limited to text, writings, video, audio, photographs, graphics, comments, suggestions, or personal information or other material (collectively, "Contributions"). </p>
                           	...
                           	<p>2. you are the creator and owner of or have the necessary licenses, rights, consents, releases, and permissions to use and to authorize us, the Site, and other users of the Site to use your Contributions in any manner contemplated by the Site and these Terms and Conditions.</p>
                           	<p>3. you have the written consent, release, and/or permission of each and every identifiable individual person in your Contributions to use the name or likeness of each and every such identifiable individual person to enable inclusion and use of your Contributions in any manner contemplated by the Site and these Terms and Conditions.</p>
                           	...
                           	<p>14. your Contributions do not otherwise violate, or link to material that violates, any provision of these Terms and Conditions, or any applicable law or regulation.</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">CONTRIBUTION LICENSE</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">GUIDELINES FOR REVIEWS</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">MOBILE APPLICATION LICENSE</p>
                           	<p style="font-weight: 700;">Use License</p>
                           	...
                           	<p style="font-weight: 700;">Apple and Android Devices</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">SOCIAL MEDIA</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">SUBMISSIONS</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">THIRD-PARTY WEBSITES AND CONTENT</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">ADVERTISERS</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">SITE MANAGEMENT</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">PRIVACY POLICY</p>
                           	<p>We care about data privacy and security. Please review our <a href=""> Privacy Policy </a> [CLICK HERE] /posted on the Site]. By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms and Conditions. Please be advised the Site is hosted in the United States.</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY</p>
                           	<p style="font-weight: 700;">Notifications</p>
                           	...
                           	<p style="font-weight: 700;">Counter Notification</p>
...
[email]
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">COPYRIGHT INFRINGEMENTS</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">TERM AND TERMINATION</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">MODIFICATIONS AND INTERRUPTIONS </p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">GOVERNING LAW </p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">DISPUTE RESOLUTION</p>
                           	<p>Option 1: Any legal action of whatever nature brought by either you or us (collectively, the “Parties” and individually, a “Party”) shall be commenced or prosecuted in the state and federal courts located in [name of county] County, [name of state], and the Parties </p>
                           	<p>hereby consent to, and waive all defenses of lack of personal jurisdiction and forum non conveniens with respect to venue and jurisdiction in such state and federal courts.</p>
                           	...
                           	<p style="font-weight: 700;">Option 2: Informal Negotiations</p>
                           	...
                           	<p style="font-weight: 700;">Binding Arbitration</p>
                           	...
                           	<p style="font-weight: 700;">Option 3: Binding Arbitration</p>
                           	...
                           	<p style="font-weight: 700;">Option 2/Option 3: Restrictions</p>
                           	<p>The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.</p>
                           	<p style="font-weight: 700;">Option 2/Option 3: Exceptions to [Informal Negotiations and] Arbitration</p>
                           ...
                           <!-- 	<p style="font-weight: 700;">Counter Notification</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">CORRECTIONS</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">LIMITATIONS OF LIABILITY</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">INDEMNIFICATION</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">USER DATA</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">CALIFORNIA USERS AND RESIDENTS</p>
                           	<p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p>
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">MISCELLANEOUS</p>
                           	...
                           	<p _ngcontent-ngq-c160="" class="sub-title shu-mb-mt">CONTACT US</p>
