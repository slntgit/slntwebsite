      ...
      <form id="submit" action="<?=base_url();?>" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-sm-12 chooesBtn">
                <h2 for="memberid" class="titleHead"  style="padding:20px 0px;">
                	Choose Event Type
                </h2>
                    <?php 
                    $count=0;
...
<hr />
	...
	<div class="col-sm-12">
    <div class="row">
        <div class='col-sm-6 col-xs-12'  style="margin-top:40px;">
               <div class="form-group">
                    <h4 for="datetimeids" class="label-control"  style="font-size:18px; font-weight:700">Date</h4>
                    <br />
 <input type="text" class="form-control datetimepicker" value="<?php  if($cvr_count>0){ echo $cvr->datetimeids; } ?>" name="datetimeids" id="datetimeids"  required>
                </div>
        </div>
    </div>
</div></div>
...
<link rel="stylesheet" href="<?=base_url();?>assets/stl-dt.css" />
<script src="<?=base_url();?>assets/stl-dt.js"></script>
