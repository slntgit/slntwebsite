                ...
                <div class="d-flex align-content-center align-content-between m-auto relative">
                    <div  id="logo" class="logo m-auto">
                       <a href="<?php echo base_url()?>">
                         <img  src="<?php echo base_url()?>assets/setting/<?php echo $webconfig->company_logo;?>"  title="<?php echo $webconfig->meta_title;?>"  alt="<?php echo $webconfig->meta_title;?>" class="img-responsive" />
                       </a>
                    </div>
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                              ...
                              <div class="dropdown-divider"></div>
                               ...
                               <a class="dropdown-item" href="<?=base_url();?>Temple-Refreshment-Booking">Temple / Refreshment Booking</a>
                              <div class="dropdown-divider"></div>
