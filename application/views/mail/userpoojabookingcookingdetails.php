...
if($this->uri->segment(3)=='' && $this->uri->segment(4)==''){
     $bookingidsss = $bookingid;
                            ...
                            $bookingidsss = $booking_details->booking_id;
 }
...
table td {
    ...
    padding-left:10px !important;
      	                 ...
      	                 <?php if($pujabooking->status==3){ ?>
            					    <tr>
                						<td colspan="5" style="color:red;">
            			    				Cancel booking			
                						</td>
            					    </tr>
            			<?php } else if($pujabooking->req_date!=''){ 
    					         $this->db->select('*');
                            $this->db->from('slnt_puja_time');
                            $this->db->where('id',$pujabooking->time_id);
                            $this->db->where('pooja_time',$pujabooking->req_time);
                            $bo = $this->db->get();
                            $ac = $bo->row();
    					?>
    					    <tr>
    						...
    						<td colspan="4" style="color:red;">
			    				<span><?php echo date("d M Y", strtotime($pujabooking->req_date));?></span>	
    						</td>
    						<th>
			    				Time of Pooja					
    						</th>
    						<td colspan="4"  style="color:red;">
			    					...
			    					<?php if($bo->num_rows()>0){ ?> <?=$ac->from_time;?> - <?=$ac->to_time;?> <?php } ?></span>	
    						</td>
    					</tr>
