...
?>
    <form method="post" action="<?=base_url();?>pujaBooking/Membership/<?=$this->uri->segment(3);?>/buyNow"> 
                        ...
                        <tr>
                            <th align="center" colspan="2">
                                <p class="text-center text-danger">
                                    Your membership is expiring / expired within <?= $days;?> days. If you want to have Pooja booking with membership price, Would you like to renew your membership with current Puja Booking? If so, You wil get membership price for current Puja Booking.
                                </p>
 ...
 <?php
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="2">
                                    <a href="<?=base_url();?>Ceremonies/GeneralInformation" mat-flat-button="" color="primary" class="mat-focus-indicator mat-flat-button mat-button-base mat-primary text-white">
