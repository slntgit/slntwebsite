<script src="https://kit.fontawesome.com/420a8676b0.js" crossorigin="anonymous"></script>
        ...
        <div _ngcontent-ngq-c158="" class="footer-widthX">
            <div _ngcontent-ngq-c158="" class="container">
                <div _ngcontent-ngq-c158="" class="row">
                    <div _ngcontent-ngq-c158="" class="col-12 text-center mb-30"><img _ngcontent-ngq-c158="" src="<?=base_url();?>assets/about-img/logo.png" alt="Shree Lakshminarayan Temple" class="img-fluid logo" /></div>
                    ...
                    <div _ngcontent-ngq-c158="" class="col-md-1"></div>

                    <div _ngcontent-ngq-c158="" class="col-md-3 ">
                        <div _ngcontent-ngq-c158="" class="widget">
                            <div _ngcontent-ngq-c158="" class="widget-header"><h4 _ngcontent-ngq-c158="">Quick Links</h4></div>
                            <div _ngcontent-ngq-c158="" class="widget-nav content mb-30 mt-13">
                                <ul _ngcontent-ngq-c158="">
                                    <li _ngcontent-ngq-c158=""><a _ngcontent-ngq-c158="" href="<?=base_url();?>">Home</a></li>
                                    <li _ngcontent-ngq-c158=""><a _ngcontent-ngq-c158="" href="<?=base_url('about');?>">About Us</a></li>
                                    <li _ngcontent-ngq-c158=""><a _ngcontent-ngq-c158="" href="<?=base_url('poojaBooking/Membership?type=pooja');?>">Booking</a></li>
                                    <li _ngcontent-ngq-c158=""><a _ngcontent-ngq-c158="" href="<?=base_url('Events');?>">Events</a></li>
                                    <li _ngcontent-ngq-c158=""><a _ngcontent-ngq-c158="" href="<?=base_url('applyMembership');?>">Membership</a></li>
                                    <li _ngcontent-ngq-c158=""><a _ngcontent-ngq-c158="" href="<?=base_url('contact');?>">Contact</a></li>
                    ...
                    <div _ngcontent-ngq-c158="" class="col-md-3">
                        <div _ngcontent-ngq-c158="" class="widget">
                            ...
                            <div _ngcontent-ngq-c158="" class="widget-nav content mb-30 mt-13">
                                <ul _ngcontent-ngq-c158="">
                                    <li _ngcontent-ngq-c158=""><a _ngcontent-ngq-c158="" href="tel:+65 62930195 "><span><i class="fas fa-phone-alt"></i></span> &nbsp;&nbsp;  +65 62930195</a></li>
                                    <li _ngcontent-ngq-c158=""><a _ngcontent-ngq-c158="" href="https://api.whatsapp.com/send?phone=6592957866&text=hi"><span><i class="fab fa-whatsapp"></i></span> &nbsp;&nbsp;  +65 92957866 </a></li>

                                    <li _ngcontent-ngq-c158=""><a _ngcontent-ngq-c158="" href="mailto:admin@spslnt.org.sg "><span><i class="far fa-envelope"></i></span> &nbsp;&nbsp;  admin@spslnt.org.sg</a></li>
                                </ul>
                            </div>
                            <div _ngcontent-ngq-c158="" class="widget-header"><h4 _ngcontent-ngq-c158="">Address</h4></div>
                            <div _ngcontent-ngq-c158="" class="widget-description"><p _ngcontent-ngq-c158="">5 Chander Rd, Singapore 219528</p></div>
                        </div>
                    </div>
                    <div _ngcontent-ngq-c158="" class="col-md-1"></div>
                    ...
                    <div _ngcontent-ngq-c158="" class="col-md-3">
                        <div _ngcontent-ngq-c158="" class="widget">
                            <div _ngcontent-ngq-c158="" class="widget-header"><h4 _ngcontent-ngq-c158="">Follow us</h4></div>
                            <div _ngcontent-ngq-c158="" class="widget-nav content">
                                                <ul _ngcontent-ngq-c158="" class="social-media">
                                                    <li _ngcontent-ngq-c158="">
                                                        <a _ngcontent-ngq-c158="" href="https://www.facebook.com/spslnt/"><i _ngcontent-ngq-c158="" class="fa fa-facebook"></i><span class="shu-icon">Facebook</span></a>
                                                    </li>
                                                    <!--<li _ngcontent-ngq-c158="">-->
                                                    <!--    <a _ngcontent-ngq-c158="" href="# "><i _ngcontent-ngq-c158="" class="fa fa-twitter"></i><span class="shu-icon">Twitter</span> </a>-->
                                                    <!--</li>-->
                                                    <li _ngcontent-ngq-c158="">
                                                        <a _ngcontent-ngq-c158="" href="https://www.youtube.com/channel/UCS5HOjefXsPyRL5heHTSU2g"><i _ngcontent-ngq-c158="" class="fa fa-youtube-play"></i><span class="shu-icon">Youtube</span></a>
                                                    </li>
                                                    <!--<li _ngcontent-ngq-c158="">-->
                                                    <!--    <a _ngcontent-ngq-c158="" href="# "><i _ngcontent-ngq-c158="" class="fa fa-instagram"></i><span class="shu-icon">Instagram</span></a>-->
                                                    <!--</li> -->
                                                </ul>
                            </div>
                        </div>
                ...
                <div _ngcontent-ngq-c158="" class="row">
                    <div _ngcontent-ngq-c158="" class="col-12">
                        <div _ngcontent-ngq-c158="" class="copyright" style="color:#696864;">
                            Copyright © <span _ngcontent-ngq-c158=""><a _ngcontent-ngq-c158="" style="color:#c5514c;" href="/">Siddh Peeth Shree Lakshminirayan Temple</a></span> 2021 All rights reserved.<a href="<?=base_url('terms-and-conditions');?>" style="color:#696864;" target="_blank">
                              Terms and Conditions 
                         </a> & <a href="<?=base_url('privacy-policy');?>" style="color:#696864;" target="_blank">
                              Privacy Policy 
                         </a>   
                        </div>
                    </div>
...
$(document).ready(function(){
  ...
  <script type="text/javascript">
        function getChangeRadio(arg) {
          //$('#menu_details').html(arg);
              var queryString='menus='+arg;
                $.ajax({
                       type: "post",
                       url: '<?php echo site_url('PoojaBooking/getCateringDetails');?>',
                       cache: false, 
                       data:queryString,
                       success: function(response){
                            $('#menu_details').html(response);
                       },
                       error: function(){      
                        alert('Error while request..');
                    }
