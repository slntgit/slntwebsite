...
//$paypal_id = 'myintmyintzanster-facilitator@gmail.com'; //Business Email
$paypal_id = 'info@lakshminarayantemple.com'; //Business Email
?>
<!--<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">-->
<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
<!--<input type="text" name="business" value="myintmyintzanster-facilitator@gmail.com"  style="opacity: 0; position: absolute;">-->
