            ...
            <div class="row">
                ...
                <div class="wrapperForm">
                    <div class="row">
                        <div class="col-md-12">
                            <label class="mb-3">
<input onchange="mem_state_user(this.value);" type="radio" name="member_profile_status" value="1"  <?php if(set_value('member_profile_status')){ if(set_value('member_profile_status')==1){  echo 'checked'; } } else { echo '';} ?>/>I am member</label>
                            <label class="mb-3">&nbsp;&nbsp;
<input onchange="mem_state_user(this.value);" type="radio" name="member_profile_status" value="0" <?php if(set_value('member_profile_status')){ if(set_value('member_profile_status')==0){  echo 'checked'; } } else { echo 'checked';} ?>  />I am not a member</label>
                        </div>
                        <div class="col-md-12">
                            <label for="member_id_old">Membership ID</label>  
<input <?php if(set_value('member_profile_status')){ if(set_value('member_profile_status')==0){  echo 'readonly'; } } else { echo 'readonly';} ?> value="<?php if(set_value('member_id_old')){ echo set_value('member_id_old');  } else { echo @$memrd->member_id_old; } ?>" type="text" name="member_id_old" class="form-control" id="member_id_old" />
...
<script>
    ...
    function mem_state_user(str){
         //member_id_old
         if(str==1){
            $('#member_id_old').removeAttr('readonly');
            $('#member_id_old').attr('required','required');
         } else {
            $('#member_id_old').attr('readonly','readonly');
            $('#member_id_old').removeAttr('required');
            $('#member_id_old').val('');
         }
    }
</script>
