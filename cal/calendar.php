     ...
     while ($currentDay <= $numberDays) {
          ...
          if ($date == date("Y-m-d")){
           $calendar .= "<td class='day today' rel='$date'><span class='today-date'>$currentDay</span></td>";
              ...
              if($dayofdates=='Fri' || $dayofdates=='Tue'){
                   $calendar .= "<td class='day'  style='background:green;'  id='$currentDay' rel='$dayofdates'><span class='day-date'>$currentDay<input type='radio' name='$currentDay' value='$currentDay' id='$currentDay' class='sel_date' /></span></td>";
              } else {
                   $calendar .= "<td class='day' style='background:red;' id='$currentDay' rel='$dayofdates'><span class='day-date'><input type='radio' name='$currentDay' value='$currentDay' id='$currentDay' class='sel_date' /></span></td>";
              }
